					...
					<div style="padding:10px;"> <img src="images/bw_whatis.gif">
						...
						<!-- Key features -->
							<div style="padding-top:10px"> <img src="images/key_features.gif">
								...
								<div style="padding-top: 20px;"> <img src="images/bt_fast.jpg" align="middle"> <a href="features.jsp" class="blue">Fast. Really fast.</a> <img style="padding-left:100px;" src="images/bt_language.jpg" align="middle"> <a href="features.jsp" class="blue">Multi language support</a> </div>
								<div style="padding-top: 20px;"> <img src="images/bt_customizable.jpg" align="middle"> <a href="features.jsp" class="blue">Customizable user interface</a> <img style="padding-left:51px;" src="images/bt_database.jpg" align="middle"> <a href="features.jsp" class="blue">Multi database</a> </div>
								<div style="padding-top: 20px;"> <img src="images/bt_secure.jpg" align="middle"> <a href="features.jsp" class="blue">Very secure</a> <img style="padding-left:128px;" src="images/bt_opensource.jpg" align="middle"> <a href="features.jsp" class="blue">Open Source</a> </div>
								<div style="padding-top: 20px;"> <img src="images/bt_fullfeature.jpg" align="middle"> <a href="features.jsp" class="blue"><b>See the compleate feature list here</b></a> </div>
							</div>
					</div>
