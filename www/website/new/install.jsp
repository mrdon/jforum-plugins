...
<table>
	<tr>
		<td colspan="2" valign="top">
			...
			<img src="img/h_bar.gif" width="100%" height="2">
		</td>
	</tr>
...
<!-- Downloadig -->
<p><img src="img/info.jpg" align="middle" border="0"> <a name="downloading"></a><span class="install_subtitle">Downloading JForum</span>
<p>
To get JForum, go to the <a href="download.htm">download page</a> and get the latest version.
</p>

<!-- Installing -->
<br><img src="img/info.jpg" align="middle" align="middle"> <a name="installing"></a><span class="install_subtitle">Unpacking</span>
<p>
...
<!-- Configuring -->
<br><a name="configuring"></a><img src="img/info.jpg" align="middle" border="0"> <span class="install_subtitle">Configuring</span>
<p>
...
<!-- Administration -->
<br><a name="administering"></a><img src="img/info.jpg" align="middle" border="0"> <span class="install_subtitle">Administering the Forum</span>
<p>
