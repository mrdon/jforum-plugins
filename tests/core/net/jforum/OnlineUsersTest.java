 ...
 * 
 * @author Rafael Steil
 * @version $Id: OnlineUsersTest.java,v 1.2 2005/07/26 02:45:56 diegopires Exp $
 */
public class OnlineUsersTest extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		SystemGlobals.setValue(ConfigKeys.ANONYMOUS_USER_ID, Integer
				.toString(ANONYMOUS));
	}
	...
	public void testAnonymousCount() {
		this.createUserSession(ANONYMOUS, ANONYMOUS + 1 + "_"
				+ System.currentTimeMillis());
		this.createUserSession(ANONYMOUS, ANONYMOUS + 2 + "_"
				+ System.currentTimeMillis());
		this.createUserSession(ANONYMOUS, ANONYMOUS + 3 + "_"
				+ System.currentTimeMillis());
	...
	public void test2Anymous1Logged() {
		// Anonymous
		this.createUserSession(ANONYMOUS, ANONYMOUS + "1_"
				+ System.currentTimeMillis());
		this.createUserSession(ANONYMOUS, ANONYMOUS + "2_"
				+ System.currentTimeMillis());
