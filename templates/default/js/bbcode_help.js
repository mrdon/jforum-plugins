...
q_help = "${I18n.getMessage("PostForm.helplineQuote")}: [citar]${I18n.getMessage("PostForm.helplineText")}[/citar]  (alt+q)";
...
s_help = "${I18n.getMessage("PostForm.helplineColor")}: [cor=red]${I18n.getMessage("PostForm.helplineText")}[/cor]  ${I18n.getMessage("PostForm.helplineColorTip")} color=#FF0000";
f_help = "${I18n.getMessage("PostForm.helplineFont")}: [tamanho=x-small]${I18n.getMessage("PostForm.helplineSmallText")}[/tamanho]";