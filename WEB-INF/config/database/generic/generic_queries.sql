...
# SearchModel
# ############
SearchModel.getPostsToIndexForLucene = SELECT p.post_id, p.forum_id, p.enable_bbcode, p.enable_smilies, '' topic_title, p.topic_id, p.user_id, p.post_time, pt.post_text, pt.post_subject \
