...
CREATE TABLE jforum_karma (
	karma_id INT NOT NULL GENERATED BY DEFAULT AS IDENTITY (start with 1),
	post_id INT NOT NULL,
	topic_id INT NOT NULL,
...
CREATE TABLE jforum_bookmarks (
	bookmark_id INT NOT NULL GENERATED BY DEFAULT AS IDENTITY (start with 1),
	user_id INT NOT NULL,
...
CREATE TABLE jforum_quota_limit (
	quota_limit_id INT NOT NULL GENERATED BY DEFAULT AS IDENTITY (start with 1),
...
CREATE TABLE jforum_extension_groups (
	extension_group_id INT NOT NULL GENERATED BY DEFAULT AS IDENTITY (start with 1),
...
CREATE TABLE jforum_extensions (
	extension_id INT NOT NULL GENERATED BY DEFAULT AS IDENTITY (start with 1),
...
CREATE TABLE jforum_attach (
	attach_id INT NOT NULL GENERATED BY DEFAULT AS IDENTITY (start with 1),
	post_id INT,
	privmsgs_id INT,
	user_id INT NOT NULL,
...
CREATE TABLE jforum_attach_desc (
	attach_desc_id INT NOT NULL GENERATED BY DEFAULT AS IDENTITY (start with 1),
...
CREATE TABLE jforum_attach_quota (
	attach_quota_id INT NOT NULL GENERATED BY DEFAULT AS IDENTITY (start with 1),
	group_id INT NOT NULL,
