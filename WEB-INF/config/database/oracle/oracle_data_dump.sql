...
INSERT INTO jforum_topics VALUES (1,1,'Welcome to JForum',2, SYSDATE,1,0,0,0,0,1,1,0);
INSERT INTO jforum_posts VALUES (1,1,1,2,'2005-01-04 16:59:54','127.0.0.1',1,0,1,1,SYSDATE,2,1,0);
...
SELECT jforum_categories_seq.nextval FROM dual;
SELECT jforum_forums_seq.nextval FROM dual;
SELECT jforum_topics_seq.nextval FROM dual;
SELECT jforum_posts_seq.nextval FROM dual;
