...
CREATE TABLE jforum_privmsgs (
  ...
  privmsgs_date timestamp default null,
...
CREATE TABLE jforum_topics (
  ...
  user_id mediumint(8) NOT NULL default '0',
  topic_time timestamp default null,
...
CREATE TABLE jforum_users (
  ...
  user_session_time timestamp default null,
  user_session_page smallint(5) NOT NULL default '0',
  user_lastvisit timestamp default null,
  user_regdate timestamp default null,
  ...
  user_emailtime timestamp default NULL,
