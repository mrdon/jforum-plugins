...
CREATE TABLE jforum_privmsgs (
  ...
  privmsgs_date datetime NOT NULL default '0',
...
CREATE TABLE jforum_sessions (
  ...
  session_start datetime NOT NULL default '0',
  session_time datetime NOT NULL default '0',
...
CREATE TABLE jforum_topics (
  ...
  user_id mediumint(8) NOT NULL default '0',
  topic_time datetime NOT NULL default '0',
