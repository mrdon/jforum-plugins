...
CREATE TABLE jforum_privmsgs (
  ...
  privmsgs_date VARCHAR(13) NOT NULL DEFAULT 0,
...
CREATE TABLE jforum_sessions (
  ...
  session_time VARCHAR(13) NOT NULL DEFAULT 0,
...
CREATE TABLE jforum_users (
  ...
  user_session_time VARCHAR(13) NOT NULL DEFAULT 0,
  user_session_page INTEGER NOT NULL DEFAULT 0,
  user_lastvisit INTEGER NOT NULL DEFAULT 0,
  user_regdate VARCHAR(13) NOT NULL DEFAULT 0,
  ...
  user_emailtime INTEGER DEFAULT NULL,
