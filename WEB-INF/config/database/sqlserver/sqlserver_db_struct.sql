...
CREATE TABLE [jforum_search_topics] (
	...
	[topic_vote_id] [tinyint] DEFAULT (0) NULL ,
...
CREATE TABLE [jforum_attach_quota] (
 ...
 CREATE  INDEX [idx_fw_forum] ON [jforum_forums_watch]([forum_id]) ON [PRIMARY];
 CREATE  INDEX [idx_fw_user] ON [jforum_forums_watch]([user_id]) ON [PRIMARY];
